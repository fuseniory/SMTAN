import logging
import torch
from smtan.utils.comm import get_world_size
from smtan.utils.imports import import_file
...
def build_dataset(dataset_list, dataset_catalog, cfg, is_train=True):
    ...
    for dataset_name in dataset_list:
        ...
        args["num_clips"] = cfg.MODEL.SMTAN.NUM_CLIPS
        args["remove_person"] = cfg.MODEL.SMTAN.LOSS.CONTRASTIVE
...
def make_data_loader(cfg, is_train=True, is_distributed=False, is_for_period=False):
    ...
    paths_catalog = import_file(
        "smtan.cfg.paths_catalog", cfg.PATHS_CATALOG, True
    )
