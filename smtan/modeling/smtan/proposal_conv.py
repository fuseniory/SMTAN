...
def build_proposal_conv(cfg, mask2d):
    input_size = cfg.MODEL.SMTAN.FEATPOOL.HIDDEN_SIZE
    hidden_size = cfg.MODEL.SMTAN.PREDICTOR.HIDDEN_SIZE
    kernel_size = cfg.MODEL.SMTAN.PREDICTOR.KERNEL_SIZE
    num_stack_layers = cfg.MODEL.SMTAN.PREDICTOR.NUM_STACK_LAYERS
    output_size = cfg.MODEL.SMTAN.JOINT_SPACE_SIZE
