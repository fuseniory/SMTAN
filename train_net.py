...
from smtan.engine.trainer import do_train
...
from smtan.utils.miscellaneous import mkdir, save_config
...
def train(cfg, local_rank, distributed):
    ...
    if cfg.SOLVER.RESUME:
        ...
        if cfg.DATASETS.NAME == "activitynet":
            weight_path = './outputs/%s_activitynet_64x64_k9l4/%s_model_%de.pth' % (cfg.MODEL.SMTAN.FEAT2D.NAME, cfg.MODEL.SMTAN.FEAT2D.NAME, cfg.SOLVER.RESUME_EPOCH - 1)
        elif cfg.DATASETS.NAME == "tacos":
            weight_path = './outputs/%s_tacos_128x128_k5l8/%s_model_%de.pth' % (cfg.MODEL.SMTAN.FEAT2D.NAME, cfg.MODEL.SMTAN.FEAT2D.NAME, cfg.SOLVER.RESUME_EPOCH - 1)
        elif cfg.DATASETS.NAME == "charades":
            weight_path = './outputs/%s_charades_16x16_k5l8/%s_model_%de.pth' % (cfg.MODEL.SMTAN.FEAT2D.NAME, cfg.MODEL.SMTAN.FEAT2D.NAME, cfg.SOLVER.RESUME_EPOCH - 1)
        else:
